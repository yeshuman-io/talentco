...
class ApplicationService:
    ...
    @transaction.atomic
    def change_stage(self, application_id: str, stage_slug: str, actor_id: Optional[int] = None) -> Application:
    ...
    @transaction.atomic
    def withdraw_application(self, application_id: str, reason: Optional[str] = None) -> Application:
    ...
    @transaction.atomic
    def record_decision(self, application_id: str, status: str, reason_text: Optional[str] = None) -> Application:
    ...
    @transaction.atomic
    def upsert_screening_question(self, opportunity_id: str, payload: Dict[str, Any]) -> OpportunityQuestion:
    ...
    @transaction.atomic
    def delete_screening_question(self, question_id: str) -> None:
        OpportunityQuestion.objects.filter(id=question_id).delete()

    @transaction.atomic
    def submit_answers(self, application_id: str, answers_payload: List[Dict[str, Any]]) -> List[ApplicationAnswer]:
        application = Application.objects.get(id=application_id)
    ...
    @transaction.atomic
    def schedule_interview_minimal(
        self,
        application_id: str,
        round_name: str,
        scheduled_start,
