...
class ApplicationStageInstance(models.Model):
    ...
    entered_by = models.ForeignKey(
        "auth.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="entered_application_stages"
    )
...
class ApplicationEvent(models.Model):
    ...
    actor = models.ForeignKey("auth.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="application_events")
    created_at = models.DateTimeField(auto_now_add=True)
